...
configure_system() {
    ...
    # the clearnet user to access. Virtaul machine manager (running as the clearnet user)
    # will be writing to it. And even though Virtual machine manager will run as the
    ...
    # Create Clearnet Virtual Machine Manager system launcher
    local LAUNCHER_FILE_NAME="clearnet-virt-manager.desktop"
